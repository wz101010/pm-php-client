...
/**
 * CurrencyConsumeRequest Class Doc Comment
 *
 * @category Class
 * @package  PMCore/Client
 * @author   OpenAPI Generator team
 ...
 */
class CurrencyConsumeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrencyConsumeRequest';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CurrencyConsumeRequest., must be bigger than or equal to 1.');
        }
