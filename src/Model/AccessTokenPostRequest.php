...
/**
 * AccessTokenPostRequest Class Doc Comment
 *
 * @category Class
 * @package  PMCore/Client
 * @author   OpenAPI Generator team
 ...
 */
class AccessTokenPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessTokenPostRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['expire_in_days']) && ($this->container['expire_in_days'] > 3650)) {
            $invalidProperties[] = "invalid value for 'expire_in_days', must be smaller than or equal to 3650.";
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling AccessTokenPostRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets expire_in_days
     *
     * @param int|null $expire_in_days expire_in_days
     *
     * @return self
     */
    public function setExpireInDays($expire_in_days)
    {
        ...
        if (($expire_in_days > 3650)) {
            throw new \InvalidArgumentException('invalid value for $expire_in_days when calling AccessTokenPostRequest., must be smaller than or equal to 3650.');
        }
        if (($expire_in_days < -1)) {
            throw new \InvalidArgumentException('invalid value for $expire_in_days when calling AccessTokenPostRequest., must be bigger than or equal to -1.');
        }
