...
class CreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['product_type']) < 1)) {
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling CreateOrderRequest., must be bigger than or equal to 0.01.');
        }
    ...
    public function setProductName($product_name)
    {
        ...
        if ((mb_strlen($product_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_name when calling CreateOrderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProductType($product_type)
    {
        ...
        if ((mb_strlen($product_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_type when calling CreateOrderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setProductId($product_id)
    {
        ...
        if ((mb_strlen($product_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_id when calling CreateOrderRequest., must be bigger than or equal to 1.');
        }
