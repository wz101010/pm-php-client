...
/**
 * AlipayCreateOrderRequest Class Doc Comment
 *
 * @category Class
 * @package  PMCore/Client
 * @author   OpenAPI Generator team
 ...
 */
class AlipayCreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlipayCreateOrderRequest';
    ...
    */
    ...
    public function setOrderNo($order_no)
    {
        ...
        if ((mb_strlen($order_no) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_no when calling AlipayCreateOrderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling AlipayCreateOrderRequest., must be bigger than or equal to 0.01.');
        }
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling AlipayCreateOrderRequest., must be bigger than or equal to 1.');
        }
