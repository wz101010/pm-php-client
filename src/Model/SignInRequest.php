    ...
    */
    ...
    public function setUserName($user_name)
    {
        ...
        if ((mb_strlen($user_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling SignInRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPwd($pwd)
    {
        ...
        if ((mb_strlen($pwd) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pwd when calling SignInRequest., must be bigger than or equal to 1.');
        }
