    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ServiceGroup., must be smaller than or equal to 100.');
        }
    ...
    public function setCode($code)
    {
        ...
        if (!is_null($code) && (mb_strlen($code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ServiceGroup., must be smaller than or equal to 50.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if (!is_null($icon) && (mb_strlen($icon) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling ServiceGroup., must be smaller than or equal to 255.');
        }
