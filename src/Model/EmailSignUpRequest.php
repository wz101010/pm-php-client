...
/**
 * EmailSignUpRequest Class Doc Comment
 *
 * @category Class
 * @package  PMCore/Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailSignUpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailSignUpRequest';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling EmailSignUpRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPwd($pwd)
    {
        ...
        if ((mb_strlen($pwd) > 32)) {
            throw new \InvalidArgumentException('invalid length for $pwd when calling EmailSignUpRequest., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($pwd) < 6)) {
            throw new \InvalidArgumentException('invalid length for $pwd when calling EmailSignUpRequest., must be bigger than or equal to 6.');
        }
     ...
     * Sets email_code
     *
     * @param string|null $email_code 邮箱验证码
     *
     * @return self
     */
    public function setEmailCode($email_code)
    {
        ...
        if (!is_null($email_code) && (!preg_match("/\\d{4,8}$/", ObjectSerializer::toString($email_code)))) {
            throw new \InvalidArgumentException("invalid value for \$email_code when calling EmailSignUpRequest., must conform to the pattern /\\d{4,8}$/.");
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/^(\\d{11})?$/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling EmailSignUpRequest., must conform to the pattern /^(\\d{11})?$/.");
        }
    ...
    public function setPhoneCode($phone_code)
    {
        ...
        if (!is_null($phone_code) && (!preg_match("/\\d{4,8}$/", ObjectSerializer::toString($phone_code)))) {
            throw new \InvalidArgumentException("invalid value for \$phone_code when calling EmailSignUpRequest., must conform to the pattern /\\d{4,8}$/.");
        }
    ...
    public function setNickName($nick_name)
    {
        ...
        if (!is_null($nick_name) && (mb_strlen($nick_name) > 99)) {
            throw new \InvalidArgumentException('invalid length for $nick_name when calling EmailSignUpRequest., must be smaller than or equal to 99.');
        }
    ...
    public function setAvatar($avatar)
    {
        ...
        if (!is_null($avatar) && (mb_strlen($avatar) > 999)) {
            throw new \InvalidArgumentException('invalid length for $avatar when calling EmailSignUpRequest., must be smaller than or equal to 999.');
        }
    ...
    public function setData($data)
    {
        ...
        if (!is_null($data) && (mb_strlen($data) > 9999)) {
            throw new \InvalidArgumentException('invalid length for $data when calling EmailSignUpRequest., must be smaller than or equal to 9999.');
        }
