...
/**
 * PostIndexRequest Class Doc Comment
 *
 * @category Class
 * @package  PMCore/Client
 * @author   OpenAPI Generator team
 ...
 */
class PostIndexRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostIndexRequest';
    ...
    */
     ...
     * Sets model
     *
     * @param array<string,array> $model model
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param array<string,array>|null $options options
     *
     * @return self
     */
