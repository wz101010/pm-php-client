...
/**
 * OAuthAccountSignInRequest Class Doc Comment
 *
 * @category Class
 * @package  PMCore/Client
 * @author   OpenAPI Generator team
 ...
 */
class OAuthAccountSignInRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OAuthAccountSignInRequest';
    ...
    */
    ...
    public function setUnionId($union_id)
    {
        ...
        if ((mb_strlen($union_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $union_id when calling OAuthAccountSignInRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatform($platform)
    {
        ...
        if ((mb_strlen($platform) < 1)) {
            throw new \InvalidArgumentException('invalid length for $platform when calling OAuthAccountSignInRequest., must be bigger than or equal to 1.');
        }
