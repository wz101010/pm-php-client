...
class StorageApi
{
     ...
     * @param  string $table 表名称 (required)
     * @param  string $app_key app_key (required)
     * @param  string|null $filter 筛选条件 (optional)
     ...
     * @param  string $app_key app_key (required)
     * @param  \PMCore/Client\PMCore/Client/Model\ExecuteFunctionRequest|null $execute_function_request  (optional)
     ...
     * @param  \DateTime|null $start_time  (optional)
     ...
     * @param  string $table 表名称（小写字母加数字,1-50位） (required)
     * @param  string $app_key app_key (required)
     * @param  \PMCore/Client\PMCore/Client/Model\PostIndexRequest|null $post_index_request json对象 / json数组 (optional)
     ...
     * @param  string $id 数据ID (required)
     * @param  string $app_key app_key (required)
     * @param  mixed $body json格式 (required)
     ...
     * @return \PMCore/Client\PMCore/Client/Model\JObjectApiResult
     */
    public function storagePut($table, $id, $app_key, $body, $replace = false, string $contentType = self::contentTypes['storagePut'][0])
    {
        list($response) = $this->storagePutWithHttpInfo($table, $id, $app_key, $body, $replace, $contentType);
        return $response;
    }
     ...
     * @return array of \PMCore/Client\PMCore/Client/Model\JObjectApiResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function storagePutWithHttpInfo($table, $id, $app_key, $body, $replace = false, string $contentType = self::contentTypes['storagePut'][0])
    {
        $request = $this->storagePutRequest($table, $id, $app_key, $body, $replace, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePutAsync($table, $id, $app_key, $body, $replace = false, string $contentType = self::contentTypes['storagePut'][0])
    {
        return $this->storagePutAsyncWithHttpInfo($table, $id, $app_key, $body, $replace, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function storagePutAsyncWithHttpInfo($table, $id, $app_key, $body, $replace = false, string $contentType = self::contentTypes['storagePut'][0])
    {
        $returnType = '\PMCore/Client\PMCore/Client/Model\JObjectApiResult';
        $request = $this->storagePutRequest($table, $id, $app_key, $body, $replace, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function storagePutRequest($table, $id, $app_key, $body, $replace = false, string $contentType = self::contentTypes['storagePut'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling storagePut'
            );
        }
