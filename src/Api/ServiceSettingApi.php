...
class ServiceSettingApi
{
     ...
     * 添加服务分组
     *
     * @param  \PMCore/Client\PMCore/Client/Model\ServiceGroup|null $service_group  (optional)
     ...
     * 服务分组
     *
     * @param  int|null $provider_id  (optional)
     * @param  bool|null $show_flag  (optional, default to false)
     ...
     * 添加服务配置
     *
     * @param  \PMCore/Client\PMCore/Client/Model\ServiceItem|null $service_item  (optional)
     ...
     * 服务配置列表
     *
     * @param  string|null $biz_code  (optional)
     * @param  string|null $provider_code  (optional)
     * @param  string|null $group_code  (optional)
     * @param  bool|null $show_flag  (optional, default to false)
     ...
     * 增加配置
     *
     * @param  \PMCore/Client\PMCore/Client/Model\Settings|null $settings  (optional)
     ...
     * 添加服务商
     *
     * @param  \PMCore/Client\PMCore/Client/Model\ServiceProvider|null $service_provider  (optional)
     ...
     * 配置列表
     *
     * @param  string $biz_code  (required)
     * @param  string $biz_id  (required)
     * @param  string|null $provider_code  (optional)
     * @param  string|null $group_code  (optional)
