...
```php
project($id): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$apiInstance = new PMCore/Client\Api\ProjectApi(
...
```php
projectDelete($id): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
projectPost($project): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$project = new \PMCore/Client\PMCore/Client/Model\Project(); // \PMCore/Client\PMCore/Client/Model\Project | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **project** | [**\PMCore/Client\PMCore/Client/Model\Project**](../Model/Project.md)|  | [optional] |
...
```php
projectPut($id, $project): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
projects($skip, $take): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
