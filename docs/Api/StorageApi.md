...
```php
storageAggregate($table, $app_key, $pipeline): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$apiInstance = new PMCore/Client\Api\StorageApi(
...
```php
storageClear($table, $app_key, $filter): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$table = 'table_example'; // string | 表名称
$app_key = 'app_key_example'; // string
$filter = 'filter_example'; // string | 筛选条件
...
```php
storageDelete($table, $id, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageDeleteIndex($table, $app_key, $index_name): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageDetail($table, $id, $app_key, $project): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageExecuteFunction($nonce, $timestamp, $signature, $app_key, $execute_function_request): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$app_key = 'app_key_example'; // string
$execute_function_request = new \PMCore/Client\PMCore/Client/Model\ExecuteFunctionRequest(); // \PMCore/Client\PMCore/Client/Model\ExecuteFunctionRequest | 
...
| **signature** | **string**|  | |
| **app_key** | **string**|  | |
| **execute_function_request** | [**\PMCore/Client\PMCore/Client/Model\ExecuteFunctionRequest**](../Model/ExecuteFunctionRequest.md)|  | [optional] |
...
```php
storageImport($table, $app_key, $file): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageIndexes($table, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageList($table, $app_key, $filter, $project, $sort, $start_time, $end_time, $explain, $take, $skip): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storagePost($table, $app_key, $request_body): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storagePostIndex($table, $app_key, $post_index_request): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$table = 'table_example'; // string | 表名称（小写字母加数字,1-50位）
$app_key = 'app_key_example'; // string
$post_index_request = new \PMCore/Client\PMCore/Client/Model\PostIndexRequest(); // \PMCore/Client\PMCore/Client/Model\PostIndexRequest | json对象 / json数组
...
| **table** | **string**| 表名称（小写字母加数字,1-50位） | |
| **app_key** | **string**|  | |
| **post_index_request** | [**\PMCore/Client\PMCore/Client/Model\PostIndexRequest**](../Model/PostIndexRequest.md)| json对象 / json数组 | [optional] |
...
```php
storagePut($table, $id, $app_key, $body, $replace): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageRemove($table, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageStats($table, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
storageTables($app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
