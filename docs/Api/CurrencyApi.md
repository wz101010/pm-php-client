...
```php
currencies($app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$apiInstance = new PMCore/Client\Api\CurrencyApi(
...
```php
currency($id, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
currencyDelete($id, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
currencyExchangeRateDelete($id, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
currencyExchangeRatePut($code, $app_key, $exchange_rate_put_request): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$app_key = 'app_key_example'; // string
$exchange_rate_put_request = new \PMCore/Client\PMCore/Client/Model\ExchangeRatePutRequest(); // \PMCore/Client\PMCore/Client/Model\ExchangeRatePutRequest | 
...
| **code** | **string**|  | |
| **app_key** | **string**|  | |
| **exchange_rate_put_request** | [**\PMCore/Client\PMCore/Client/Model\ExchangeRatePutRequest**](../Model/ExchangeRatePutRequest.md)|  | [optional] |
...
```php
currencyExchangeRates($code, $app_key): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
currencyPost($app_key, $currency): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
$app_key = 'app_key_example'; // string
$currency = new \PMCore/Client\PMCore/Client/Model\Currency(); // \PMCore/Client\PMCore/Client/Model\Currency | 
...
| ------------- | ------------- | ------------- | ------------- |
| **app_key** | **string**|  | |
| **currency** | [**\PMCore/Client\PMCore/Client/Model\Currency**](../Model/Currency.md)|  | [optional] |
...
```php
currencyPut($id, $app_key, $currency): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
...
```php
currencyTransactions($app_key, $user_id, $trans_type, $cur_code, $start_time, $end_time, $skip, $take): \PMCore/Client\PMCore/Client/Model\JObjectApiResult
```
